...
export default function WomenPage() {
  return (
    <main className="h-screen bg-background overflow-hidden relative">
      {/* Animated background - matches Welcome/Generator theme */}
      ...
      <div className="relative z-10 h-full p-6 flex items-start justify-center overflow-auto">
        <div className="w-full max-w-6xl">
          ...
          <header className="mb-6">
            <h1 className="text-3xl font-bold text-white">Women Prompts</h1>
            <p className="text-sm text-white/60">A curated set of portrait prompts</p>
          </header>
          <WomenGrid />
        </div>
      </div>
