...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  const [ready, setReady] = useState(true); // Start as ready to ensure visibility
  ...
  useEffect(() => {
    ...
    // Fallback timeout to ensure text is always visible
  ...
  useGSAP(
    () => {
      ...
      const build = () => {
        ...
        // Check if GSAPSplitText is available (premium plugin)
        try {
          if (!GSAPSplitText || typeof GSAPSplitText === 'undefined') {
            throw new Error('SplitText not available');
          }
        } catch (e) {
          ...
          // Simple staggered fade-in animation as fallback
          gsap.fromTo(chars, 
